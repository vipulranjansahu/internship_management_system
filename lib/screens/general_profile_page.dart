...
class General_Profile_Page extends StatefulWidget {

  String id;
  General_Profile_Page({required this.id});

  @override
  _General_Profile_PageState createState() => _General_Profile_PageState();
}

class _General_Profile_PageState extends State<General_Profile_Page> {
